...
public class Tic_Tac_Toe extends javax.swing.JFrame {
    ...
    public Tic_Tac_Toe() {
        ...
        if(JOptionPane.showConfirmDialog(this,"Confirm if you want start with X","Exit",JOptionPane.YES_NO_OPTION) == JOptionPane.YES_NO_OPTION){
    ...
    private void initComponents() {
        ...
        btn2.setForeground(new java.awt.Color(0, 51, 102));
